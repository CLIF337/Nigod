...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { background: #8b1a3a; width: 80%; height: 100%; border-radius: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="question">Что такое CSRF-атака?</div>
        <form action="question9.php" method="post">
            <div class="option"><input type="radio" name="answer8" value="Подделка межсайтового запроса" required> <label>Подделка межсайтового запроса</label></div>
            <div class="option"><input type="radio" name="answer8" value="Перехват сессии"> <label>Перехват сессии</label></div>
            <div class="option"><input type="radio" name="answer8" value="Внедрение SQL-кода"> <label>Внедрение SQL-кода</label></div>
            <div class="option"><input type="radio" name="answer8" value="DoS-атака"> <label>DoS-атака</label></div>
