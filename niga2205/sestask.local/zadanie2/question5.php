...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { background: #8b1a3a; width: 50%; height: 100%; border-radius: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="question">Как защититься от SQL-инъекций?</div>
        <form action="question6.php" method="post">
            <div class="option"><input type="radio" name="answer5" value="Использовать prepared statements" required> <label>Использовать prepared statements</label></div>
            <div class="option"><input type="radio" name="answer5" value="Отключить JavaScript"> <label>Отключить JavaScript</label></div>
            <div class="option"><input type="radio" name="answer5" value="Использовать SSL"> <label>Использовать SSL</label></div>
            <div class="option"><input type="radio" name="answer5" value="Скрыть ошибки PHP"> <label>Скрыть ошибки PHP</label></div>
