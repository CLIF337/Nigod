...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { background: #8b1a3a; width: 60%; height: 100%; border-radius: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="question">Какой параметр cookie защищает от доступа через JavaScript?</div>
        <form action="question7.php" method="post">
            <div class="option"><input type="radio" name="answer6" value="Secure" required> <label>Secure</label></div>
            <div class="option"><input type="radio" name="answer6" value="HttpOnly"> <label>HttpOnly</label></div>
            <div class="option"><input type="radio" name="answer6" value="SameSite"> <label>SameSite</label></div>
            <div class="option"><input type="radio" name="answer6" value="Domain"> <label>Domain</label></div>
