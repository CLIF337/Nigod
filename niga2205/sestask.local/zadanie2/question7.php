...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { background: #8b1a3a; width: 70%; height: 100%; border-radius: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="question">Какую функцию нужно вызвать для начала работы с сессией в PHP?</div>
        <form action="question8.php" method="post">
            <div class="option"><input type="radio" name="answer7" value="session_open()" required> <label>session_open()</label></div>
            <div class="option"><input type="radio" name="answer7" value="session_begin()"> <label>session_begin()</label></div>
            <div class="option"><input type="radio" name="answer7" value="session_start()"> <label>session_start()</label></div>
            <div class="option"><input type="radio" name="answer7" value="session_init()"> <label>session_init()</label></div>
