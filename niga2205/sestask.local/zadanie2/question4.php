...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { background: #8b1a3a; width: 40%; height: 100%; border-radius: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="question">Что такое XSS-атака?</div>
        <form action="question5.php" method="post">
            <div class="option"><input type="radio" name="answer4" value="Внедрение вредоносного SQL-кода" required> <label>Внедрение вредоносного SQL-кода</label></div>
            <div class="option"><input type="radio" name="answer4" value="Внедрение вредоносного JavaScript-кода"> <label>Внедрение вредоносного JavaScript-кода</label></div>
            <div class="option"><input type="radio" name="answer4" value="DoS-атака"> <label>DoS-атака</label></div>
            <div class="option"><input type="radio" name="answer4" value="Перехват сессии"> <label>Перехват сессии</label></div>
